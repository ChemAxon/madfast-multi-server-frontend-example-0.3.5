...
/**
 * Inject missing components into the Web UI client library.
 */

// Get MadFast WebUI client library
// Avoid polluting global environment by this IIFE (https://en.wikipedia.org/wiki/Immediately_invoked_function_expression)
(function () {
    ...
    // Function definition matches Web UI 0.3.6.
    M.landing.progress.ofTask = function(task) {
        _.checkFields({
    ...
    }; // end of function M.landing.progress.ofTask definition
})();